...
public class rabbitConfig {
    ...
    public DirectExchange directExchange() {
        return new DirectExchange("courseExchange-request");
    }

    @Bean
    public Queue directQueue() {
        return new Queue("courseQueue-request", true);
    }
    ...
    public Binding bindingDirectExchange(Queue directQueue, DirectExchange directExchange) {
        return BindingBuilder.bind(directQueue).to(directExchange).with("courseExchange-request");
    }
